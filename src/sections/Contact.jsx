...
const CONTACT_RECEIVER_EMAIL =
  import.meta.env.VITE_CONTACT_RECEIVER_EMAIL || "priyanshusinghrajput007@gmail.com";
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!EMAILJS_SERVICE_ID || !EMAILJS_TEMPLATE_ID || !EMAILJS_PUBLIC_KEY) {
      setIsLoading(false);
      showAlertMessage("danger", "Contact form is not configured yet.");
      return;
    }
  ...
  return (
    <section id="contact" className="relative flex items-center c-space section-spacing">
      ...
      <div className="flex flex-col items-center justify-center max-w-md p-5 mx-auto border rounded-2xl bg-white/90 dark:bg-primary border-slate-300/80 dark:border-white/10">
        <div className="flex flex-col items-start w-full gap-5 mb-10">
          <h2 className="text-heading">Let's Talk</h2>
          <p className="font-normal text-slate-600 dark:text-neutral-400">
